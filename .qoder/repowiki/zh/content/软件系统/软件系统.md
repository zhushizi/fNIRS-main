...
- 辅助工具：nirs_viewer.py（NIRS 数据查看器）、testing-scripts（示例脚本）
...
- [index.html](file://software/index.html#L305-L306)
...
- [adc_client.py](file://software/adc_client.py#L49-L85)
- [mBLL_animation.py](file://software/mBLL_animation.py#L44-L46)
- [nirs_viewer.py](file://software/nirs_viewer.py#L185-L367)

章节来源
- [README.md](file://software/README.md#L1-L180)
...
- 辅助工具：NIRS 数据查看器（支持 .nirs/.csv），测试脚本（示例处理流程与绘图）。

章节来源
- [index.html](file://software/index.html#L1-L750)
- [visualizer.py](file://software/visualizer.py#L52-L732)
...
- [fNIRS_processing.py](file://software/fNIRS_processing.py#L448-L496)
- [adc_live.py](file://software/adc_live.py#L191-L210)
- [adc_client.py](file://software/adc_client.py#L174-L176)
...
图示来源
- [index.html](file://software/index.html#L468-L723)
- [visualizer.py](file://software/visualizer.py#L609-L711)
...
图示来源
- [adc_client.py](file://software/adc_client.py#L59-L85)
...
图示来源
- [visualizer.py](file://software/visualizer.py#L191-L559)
...
- [nirs_viewer.py](file://software/nirs_viewer.py#L110-L182)
...
章节来源
- [index.html](file://software/index.html#L144-L298)
- [visualizer.py](file://software/visualizer.py#L609-L732)
...
章节来源
- [visualizer.py](file://software/visualizer.py#L58-L96)
...
- 示例脚本：testing-scripts 中包含完整的处理流程与绘图示例，便于理解与二次开发。

章节来源
- [README.md](file://software/README.md#L45-L100)
- [fNIRS_processing_csv.py](file://software/testing-scripts/fNIRS_processing_csv.py#L447-L497)
- [plot.py](file://software/testing-scripts/plot.py#L1-L105)