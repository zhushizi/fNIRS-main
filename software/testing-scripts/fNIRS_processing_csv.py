...
if __name__ == '__main__':
    ...
    # Read CSV file
    df = pd.read_csv("sample_data/all_groups.csv")
    ...
    final_df.to_csv("sample_data/interleaved_output.csv", index=False)

    # 8) Output the resulting DataFrame.
    print(final_df.head(20))

    # 9) Process collected data
    INPUT_CSV = "sample_data/interleaved_output.csv"  
    OUTPUT_CSV = "sample_data/processed_output.csv" 
